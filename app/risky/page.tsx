...
const Risky = () => {
  ...
  useEffect(() => {
    ...
    if (!showOverlay) {
      const audio = new Audio('https://cdn.discordapp.com/attachments/1151192799241318560/1196124857365176370/In_My_Prime.mp3?ex=665013d4&is=664ec254&hm=08107bd294f9a8852610a2ac2bfc3f7479e77ffa4dbb45b501fd9b9af6405406&');
